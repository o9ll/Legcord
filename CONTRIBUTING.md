...
- Check [GitHub enhancement issues](https://github.com/o9ll/Legcord/issues?q=label%3Aenhancement) and the [feature requests Discord channel](https://discord.com/channels/820732039253852171/1261471243123818566).
- If the feature does not exist yet, [open an issue](https://github.com/o9ll/Legcord/issues), say you want to implement it, and wait for feedback before writing large changes.
